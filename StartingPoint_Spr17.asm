...
WAITPOWER:
	...
	IN     IR_LO
	XOR    TESTVAR
	JZERO  TESTF       ; Jumps to Test1 if AC is read properly
	JUMP   WAITPOWER   ; Waits for the proper button instruction to be made
...
WAITPOWER1:
	...
	IN     IR_LO
	XOR    TESTVAR
	JZERO  TEST1       ; Jumps to Test1 if AC is read properly
	JUMP   WAITPOWER1   ; Waits for the proper button instruction to be made
...
WAITPOWER2:
	...
	IN     IR_LO
	XOR    TESTVAR
	JZERO  TEST2INIT      ; Jumps to Test1 if AC is read properly
	JUMP   WAITPOWER2   ; Waits for the proper button instruction to be made
...
WAITPOWER3:
	...
	IN     IR_LO
	XOR    TESTVAR
	JZERO  TEST3INIT       ; Jumps to Test1 if AC is read properly
	JUMP   WAITPOWER3   ; Waits for the proper button instruction to be made
